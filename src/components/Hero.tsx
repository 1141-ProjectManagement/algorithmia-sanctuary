  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, hsl(30, 15%, 6%) 0%, hsl(240, 10%, 3%) 50%, hsl(0, 0%, 2%) 100%)",
        }}
      />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <motion.h1
          ...
          style={{
            ...
            textShadow:
              "0 0 10px hsla(45, 100%, 50%, 0.8), 0 0 20px hsla(45, 100%, 50%, 0.5), 0 0 40px hsla(45, 100%, 50%, 0.3), 0 0 60px hsla(45, 100%, 50%, 0.2)",
          }}
        >
          ALGORITHMIA
          <br />
